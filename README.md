...
| PRH-03 | Commit + push WIP; mirror xi-io.net | **Done** — WIP `c2b0b16`; hub `b85cb8a` |
...
**WIP branch:** `wip/pass-b-lifecycle-display-shell` @ `c2b0b16` (source `41bd811`). xi-io.net mirror @ `b85cb8a` (Pass 13).
