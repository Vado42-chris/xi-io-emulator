...
| PRH-03 | Commit + push WIP; mirror xi-io.net | **Done** — WIP `2e03637`; hub `b85cb8a` (Pass 13 evidence; CI green `26692163994`) |
...
**WIP branch:** `wip/pass-b-lifecycle-display-shell` @ `2e03637`. xi-io.net mirror @ `b85cb8a` (Pass 13).
