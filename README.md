...
**WIP branch:** `wip/pass-b-lifecycle-display-shell` @ `754f258` (substantive) — preserved on GitHub, **not merge-ready** without review slicing. xi-io.net mirror @ `f1cf7c7` (Pass 10; Pass 11 mirror pending).
