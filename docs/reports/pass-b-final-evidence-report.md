...
| 12 | 2026-05-30 | Safe session cleanup script + troubleshooting fix (Cursor pkill false positive) | **pushed** | `db4e14c`; hub `e819893`; verify suite exit 0; cleanup status clean |
