...
| 12 | 2026-05-30 | Safe session cleanup script + troubleshooting fix (Cursor pkill false positive) | **pushed** | `d8899e7`; hub `d1b9947`; verify suite exit 0; cleanup status clean |
