...
| 12 | 2026-05-30 | Safe session cleanup script + troubleshooting fix (Cursor pkill false positive) | **pending push** | `npm run cleanup:sessions:status` clean; verify suite exit 0 |
